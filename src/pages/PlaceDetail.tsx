        ...
        <div className="PlaceDetail gap-5">
            <div className="xl:col-span-5 col-span-10 row-span-6">
              <div className="grid grid-cols-4 -mt-5">
                <div className="col-span-3 text-2xl text-left py-10 rounded-lg ">{/*`${ipfsResponse?.name*/} Type of place / Place Name {/*ipfsResponse?.attributes[0].value}`*/}</div>
                <div className="xl:text-4xl text-2xl bg-glass-500 rounded-br-lg rounded-tl-lg py-10 my-5">Level 1 {/*placeLevel ?? "NA"*/}</div>
              </div>
            ...
            bg-gradient-to-t from-glass-900 to-glass-500 p-5 rounded-lg xl:gap-5 gap-10">
              <div className="xl:col-span-2 col-span-4 text-5xl">
                {" "}
                {/*solarpunkVerificationsPerPlaceId*/}/25👍🏽<div className="text-lg"></div>
              </div>
              {/*
              ...
              */}
              {/*<a className="VerBt" href={`../VerifyPlace/${placeId}`}> */}
                ...
                <button className="DetailBT hover:bg-solar-100 hover:text-night-100 xl:col-span-1 col-span-4" onClick={openVeDialogModal}>👍🏽 Verify</button>
                {/*<VerifyModal
              ...
              <div className="xl:col-span-1 col-span-2 text-5xl">
                {/*energy ?? "0"*/}/2⚡<div className="text-lg"></div>
              </div>
              <div className="xl:col-span-1 col-span-2 text-5xl">
                {/*chip ?? "0"*/}/2💽<div className="text-lg"></div>
              </div>
              {/*<a className="VerBt" href={`../UpgradePlace/${placeId}`}> */}
              
              <button className="DetailBT xl:col-span-1 col-span-4" onClick={openUpDialogModal}>Deposit 💽</button>
                {/*<UpgradeModal
